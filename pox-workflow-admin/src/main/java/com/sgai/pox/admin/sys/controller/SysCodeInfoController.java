...
public class SysCodeInfoController extends BaseController {
     ...
     * @return
     */
    @PoxPreAuthorize("@elp.single('sys:codeInfo:list')")
     ...
     * @功能：新增
     */
    @PoxPreAuthorize("@elp.single('sys:codeInfo:save')")
     ...
     */
    @Log(value = "修改代码信息")
    @PoxPreAuthorize("@elp.single('sys:codeInfo:update')")
     ...
     */
    @Log(value = "删除代码信息")
    @PoxPreAuthorize("@elp.single('sys:codeInfo:delete')")
