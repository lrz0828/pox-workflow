 ...
 */
public class PoxTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices, ConsumerTokenServices, InitializingBean {
    ...
    public PoxTokenServices() {
    }

    public PoxTokenServices(int oldAccessTokenValiditySeconds) {
