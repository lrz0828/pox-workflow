...
public class SysUserController extends BaseController {
     ...
     * @return
     */
    @PoxPreAuthorize("@elp.single('sys:user:list')")
     ...
     */
    @Log(value = "新增用户")
    @PoxPreAuthorize("@elp.single('sys:user:save')")
     ...
     */
    @Log(value = "修改用户")
    @PoxPreAuthorize("@elp.single('sys:user:update')")
     ...
     */
    @Log(value = "删除用户")
    @PoxPreAuthorize("@elp.single('sys:user:delete')")
    ...
    public Result getUserInfo(@RequestParam(required = false) String roleId, HttpServletRequest request) {
        SysUserInfo sysUserInfo = sysUserService.saveGetUserInfo(AssertContext.getUserId(), roleId);
    ...
    @PoxPreAuthorize("@elp.single('sys:user:export')")
