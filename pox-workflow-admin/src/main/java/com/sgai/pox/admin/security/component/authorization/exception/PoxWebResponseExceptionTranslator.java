 ...
 * @author pox
 */
public class PoxWebResponseExceptionTranslator implements WebResponseExceptionTranslator<OAuth2Exception> {
        ...
        if (ase != null) {
            if (ase.getMessage() != null) {
                if (BAD_CREDENTIALS.equals(ase.getMessage())) {
                    ...
                    return new ResponseEntity<>(new PoxAuth2Exception(message,
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
        ...
        return new ResponseEntity<>(new PoxAuth2Exception(e.getMessage(), e.getOAuth2ErrorCode()), headers,
